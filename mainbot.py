...
FSUBB = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton(text="🔔 Join My Channel", url=f"https://t.me/itech99999")
        ]]
    )
   ...
   if message.chat.type == 'private': 
    try:
       ...
       await Jebot.send_message
               ...
               text="""<b>👋 Hey There, I'm a Song Downloader Bot. A bot by 👨‍💻 @itech.
            ...
            [
                [
                    InlineKeyboardButton(
                        "Add Me To Your Group ➕", url=f"https://t.me/songdownloaderitechbot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        "⚒ Create your one 📦", url="https://www.youtube.com/c/itech"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔔  My Update Channel", url=f"https://t.me/itech99999"
                    ),
                    InlineKeyboardButton(
                        "💬 Support Group ", url="https://t.me/itechbot9999"
                    )
                ]
            ]
        )
